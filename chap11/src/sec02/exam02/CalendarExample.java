...
//		System.out.println(dayOfWeek);
		...
		// plus-, minus- 관련 자동 완성으로 다양한 메소드 확인
		...
		LocalDateTime deadline = LocalDateTime.of(2025, 11, 27, 15, 0); // 2025년 11월 27일 오후 2시
		
		if (todayTime.isBefore(deadline)) {
			System.out.println("마감 시간 전입니다. 작업을 계속하세요.");			
		} else if (todayTime.isAfter(deadline)) {
			System.out.println("마감 시간이 지났습니다. 제출을 마갑합니다.");			
		} else {
		...
		System.out.println("전체 일수 차이: " + dayBetween + "일");
